...
- ### Validator Testing
   ...
   - HTML
       ...
       No error was returned when passing through the official for [index.html Showing results for contents of text-input area - Nu Html Checker.html](https://validator.w3.org/nu/#textarea)
